...
require_once 'ses.class.0.8.6.php';
...
function wpses_admin_menu() {
    $hook_suffix = add_options_page('wpses', __('WP SES', 'wp-ses'), 'manage_options', 'wp-ses-option', 'wpses_options');
...
function wpses_get_asset_url( $asset ) {
    ...
    return get_stylesheet_directory_uri() . '/inc/wp-ses/asset/' . ltrim( $asset, '/' );
}
